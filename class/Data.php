    ...
    */
    ...
    public function iterate($callback, $callback_after = null, $array = null, $recursive = true)
    {
        ...
        */
        ...
        foreach ($names as $item) {
            $val = !empty($this->custom[$item]) && !empty($array[$this->custom[$item]]) ? $array[$this->custom[$item]] : null;
        ...
        foreach ($data as $key => $item) {
            $id[$level] = $key;
            $iterable =
                !empty($this->custom['data']) &&
                !empty($item[$this->custom['data']]) &&
                System::typeIterable($item[$this->custom['data']]);
